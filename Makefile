...
gsfontdir	= /home/sam/share/X11/fonts
# x11share used in: script/apl
x11share	= /home/sam/share/X11
x11fontdir	= /home/sam/share/X11/fonts
...
# Source Locations
srcdir		= .
x11keysrc	= $(srcdir)/terminal/XFree86/keymap/apl2741.xmap
x11modesrc	= $(srcdir)/terminal/XFree86/keymap/modeswitch.xmap
confontsrc	= $(srcdir)/terminal//fonts/apl8x16.psf
keymapsrc	= $(srcdir)/terminal//keymap/apl2741.map
...
x11:		$(x11share)/apl2741.xmap $(x11share)/modeswitch.xmap \
